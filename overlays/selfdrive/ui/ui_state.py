...
class UIState:
  ...
  def _initialize(self):
    ...
    self.curvature_speed_limited: bool = False
  ...
  def _update_state(self) -> None:
    ...
    # Update curvature speed limited state from longitudinal planner
    if self.sm.updated["longitudinalPlan"]:
      lp = self.sm["longitudinalPlan"]
      self.curvature_speed_limited = getattr(lp, 'curvatureSpeedLimited', False)
