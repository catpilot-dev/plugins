...
def infer_lane_count(model_msg) -> int:
  ...
  # ~4.5 h battery, each briefly showing 40 and arming the Fix F post-narrow
  # ceiling). Per the user: a wall or barrier hugging the outer line IS a real
  ...
  # remains gas-overridable and Fix-F ceiling-capped. Pinned in
